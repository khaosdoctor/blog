...
![Animação descrevendo a importação de um módulo usando o autoimport para completar o texto](https://devblogs.microsoft.com/typescript/wp-content/uploads/sites/11/2021/03/111011663-f53c7580-834e-11eb-9a2a-3dc3ea24d0791.gif "Animação com os detalhes do autoimport para completar a declaração d emódulos importador no TypeScript")
