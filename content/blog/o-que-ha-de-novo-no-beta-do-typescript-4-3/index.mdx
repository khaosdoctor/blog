...
![Animação descrevendo a importação de um módulo usando o autoimport para completar o texto](./111011663-f53c7580-834e-11eb-9a2a-3dc3ea-032468.gif "Animação com os detalhes do autoimport para completar a declaração d emódulos importador no TypeScript")
