...
heroImage: "./timers-abort-controllers/photo-1605143185650-77944b152643-b2af67aa.jpg"
draft: false
visibility: "public"
---
...
> vamos ter um artigo especial só para tratar de event loop no node.js e todas as nuances que os timers aplicam sobre ele. por enquanto, esse conteúdo já existe na [minha série de artigos sobre o funcionamento interno do node.js](https://dev.to/khaosdoctor/node-js-por-baixo-dos-panos-3-um-mergulho-no-event-loop-38l9) que vale a pena dar uma olhada.
