...
The most common uses of `never` are to flag paths a function can't take, meaning ways it can't be used.<Sidenote>`never` is much more common in libraries and other typings that get extended by other people, you'll rarely have to use it by hand in production code.</Sidenote>
