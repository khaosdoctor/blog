...
import figureImage1 from './otimizando-custos-com-kubernetes-e-aks/image-17.png'
import figureImage2 from './otimizando-custos-com-kubernetes-e-aks/image-18.png'
import figureImage3 from './otimizando-custos-com-kubernetes-e-aks/image-19.png'
...
<Figure src={figureImage1} priority alt="" caption="Descrição das formas de cobrança para o AKS" />
...
<Figure src={figureImage2} alt="" caption="Criamos um demo-cluster em um resource group" />
...
<Figure src={figureImage3} alt="" caption="Recursos cobrados por um cluster" />
