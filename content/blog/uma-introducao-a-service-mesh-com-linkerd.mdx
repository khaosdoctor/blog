...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image.png" alt="" caption="Uma breve história do Linkerd" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-1.png" alt="" caption="Overview da arquitetura do Linkerd" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-2.png" alt="" caption="Interface web do Linkerd" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-3.png" alt="" caption="Dashboard do Grafana" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-4.png" alt="" caption="Saída com sucesso do comando" />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-5.png" alt="" caption="Saída de sucesso do linkerd check" />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-6.png" alt="" caption="Painel web do Linkerd" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-7.png" alt="" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-8.png" alt="" caption="Painel de visualização do Control Plane" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-9.png" alt="" caption="Perceba que apenas um namespaces está gerando métricas" />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-10.png" alt="" caption="Anotação do Linkerd no pod" />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-11.png" alt="" caption="O namespace está entrando no mesh" />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-13.png" alt="" wide />

Vamos abrir o painel para o deployment `porto-backend`:

<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-14.png" alt="" caption="Nosso dashboard está vazio" />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-20.png" alt="" wide />
...
<Figure src="./uma-introducao-a-service-mesh-com-linkerd/image-21.png" alt="" wide />
...
Não se esqueça de se [inscrever na newsletter](/signup/) para receber esse conteúdo e também notícias semanais! Curta e compartilhe seus feedbacks nos comentários!
