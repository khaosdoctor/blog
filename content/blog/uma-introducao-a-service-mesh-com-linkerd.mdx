...
heroImage: "./uma-introducao-a-service-mesh-com-linkerd/photo-1490253599483-a908627eb692-f1415d7e.jpg"
draft: false
visibility: "public"
---

import figureImage1 from './uma-introducao-a-service-mesh-com-linkerd/image.png'
import figureImage2 from './uma-introducao-a-service-mesh-com-linkerd/image-1.png'
import figureImage3 from './uma-introducao-a-service-mesh-com-linkerd/image-2.png'
import figureImage4 from './uma-introducao-a-service-mesh-com-linkerd/image-3.png'
import figureImage5 from './uma-introducao-a-service-mesh-com-linkerd/image-4.png'
import figureImage6 from './uma-introducao-a-service-mesh-com-linkerd/image-5.png'
import figureImage7 from './uma-introducao-a-service-mesh-com-linkerd/image-6.png'
import figureImage8 from './uma-introducao-a-service-mesh-com-linkerd/image-7.png'
import figureImage9 from './uma-introducao-a-service-mesh-com-linkerd/image-8.png'
import figureImage10 from './uma-introducao-a-service-mesh-com-linkerd/image-9.png'
import figureImage11 from './uma-introducao-a-service-mesh-com-linkerd/image-10.png'
import figureImage12 from './uma-introducao-a-service-mesh-com-linkerd/image-11.png'
import figureImage13 from './uma-introducao-a-service-mesh-com-linkerd/image-13.png'
import figureImage14 from './uma-introducao-a-service-mesh-com-linkerd/image-14.png'
import figureImage15 from './uma-introducao-a-service-mesh-com-linkerd/image-20.png'
import figureImage16 from './uma-introducao-a-service-mesh-com-linkerd/image-21.png'
...
<Figure src={figureImage1} priority alt="" caption="Uma breve história do Linkerd" wide />
...
<Figure src={figureImage2} alt="" caption="Overview da arquitetura do Linkerd" wide />
...
<Figure src={figureImage3} alt="" caption="Interface web do Linkerd" wide />
...
<Figure src={figureImage4} alt="" caption="Dashboard do Grafana" wide />
...
<Bookmark url="https://github.com/Azure-Samples/aks-bootcamp-sample/tree/finished" title="Azure-Samples/aks-bootcamp-sample" description="Demo repository for the AKS Bootcamp course. Contribute to Azure-Samples/aks-bootcamp-sample development by creating an account on GitHub." publisher="Azure-Samples" />
...
<Figure src={figureImage5} alt="" caption="Saída com sucesso do comando" />
...
<Figure src={figureImage6} alt="" caption="Saída de sucesso do linkerd check" />
...
<Figure src={figureImage7} alt="" caption="Painel web do Linkerd" wide />
...
<Figure src={figureImage8} alt="" wide />
...
<Figure src={figureImage9} alt="" caption="Painel de visualização do Control Plane" wide />
...
<Figure src={figureImage10} alt="" caption="Perceba que apenas um namespaces está gerando métricas" />
...
<Figure src={figureImage11} alt="" caption="Anotação do Linkerd no pod" />
...
<Figure src={figureImage12} alt="" caption="O namespace está entrando no mesh" />
...
![](./uma-introducao-a-service-mesh-com-linkerd/image-12.png)
...
<Figure src={figureImage13} alt="" wide />

Vamos abrir o painel para o deployment `porto-backend`:

<Figure src={figureImage14} alt="" caption="Nosso dashboard está vazio" />
...
![](./uma-introducao-a-service-mesh-com-linkerd/image-15.png)

Assim que começarmos a fazer alguns acessos podemos ver alguns dados chegando:

![](./uma-introducao-a-service-mesh-com-linkerd/image-16.png)

E podemos ver o que está acontecendo nos gráficos do grafana também!

![](./uma-introducao-a-service-mesh-com-linkerd/image-17.png)

Temos também métricas de tráfego TCP:

![](./uma-introducao-a-service-mesh-com-linkerd/image-18.png)
...
![](./uma-introducao-a-service-mesh-com-linkerd/image-19.png)
...
<Figure src={figureImage15} alt="" wide />
...
<Figure src={figureImage16} alt="" wide />

Ao clicarmos na seta esquerda, teremos uma visualização da request em detalhes

![](./uma-introducao-a-service-mesh-com-linkerd/image-22.png)
...
![](./uma-introducao-a-service-mesh-com-linkerd/image-23.png)
