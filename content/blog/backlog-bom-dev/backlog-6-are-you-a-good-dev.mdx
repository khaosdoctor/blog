...
> This might be a different study built on the same source. Either way, I couldn't confirm where these numbers came from beyond what's in the images. If anyone knows, let me know.
