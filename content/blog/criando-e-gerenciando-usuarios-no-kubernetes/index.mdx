...
Como clonamos a imagem base do AKS, ela está com o acesso administrativo por padrão, vamos remover o acesso de administrador antes de enviar para o nosso usuário:[^n1]
...
[^n1]: Para saber os nomes corretos, dê uma lida no seu arquivo `kubeconfig` para poder achar estas chaves.
