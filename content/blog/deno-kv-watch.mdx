...
heroImage: "./deno-kv-watch/articles-1.png"
draft: false
visibility: "public"
---
...
Por conta disso, a maioria das aplicações que precisavam ser feitas com algum tipo de comunicação em tempo real acabavam indo para uma direção como [WebSockets](https://pt.wikipedia.org/wiki/WebSocket), que são um pouco mais difíceis de implementar então geralmente recorríamos a long [polling](/ghost/#/editor/post/658c72263070ba187f699e8f) quando não tínhamos tanta pressa em receber as atualizações.
