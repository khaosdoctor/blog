...
Agora não temos mais a lógica de gerenciamento de recursos dentro do nosso app, o que torna muito mais fácil gerenciar essas conexões e abstrair a funcionalidade de usuários, especialmente para quem cria libs!<MarginNote>Se você quiser aprender a usar essa funcionalidade, aproveita e dá uma olhada no meu [treinamento completo de TypeScript](https://hotm.art/yd4IsL)!</MarginNote>
