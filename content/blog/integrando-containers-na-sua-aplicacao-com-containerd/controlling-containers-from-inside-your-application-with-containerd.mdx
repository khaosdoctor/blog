...
Let's start a new module by running `go mod init containerd` and then download ContainerD's client package with `go get github.com/containerd/containerd`, this will create a new `pkg` folder with the necessary files inside.

> The code you'll see below can be found [in this repo on my GitHub](https://github.com/khaosdoctor/containerd-integration-example)
