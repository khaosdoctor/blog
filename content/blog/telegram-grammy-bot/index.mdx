...
Feito isso, o bot vai te responder com um token de acesso, **mantenha esse token seguro**, porque vai ser com ele que vamos poder controlar o seu bot.<Sidenote>Se você quer entender um pouco mais, [a documentação oficial tem um guia completo](https://core.telegram.org/bots#3-how-do-i-create-a-bot)</Sidenote>
