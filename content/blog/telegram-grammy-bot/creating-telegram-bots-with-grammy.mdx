...
Once you're done, the bot will reply with an access token, **keep that token safe**, because that's what we'll use to control your bot.

> If you want to understand this a bit more, [the official docs have a full guide](https://core.telegram.org/bots#3-how-do-i-create-a-bot)
