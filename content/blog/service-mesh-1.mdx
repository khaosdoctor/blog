...
import figureImage1 from './service-mesh-1/image-8.png'
import figureImage2 from './service-mesh-1/image-10.png'
import figureImage3 from './service-mesh-1/image-12.png'
import figureImage4 from './service-mesh-1/image-14.png'
import figureImage5 from './service-mesh-1/image-13.png'
import figureImage6 from './service-mesh-1/image-15.png'
...
<Figure src={figureImage1} priority alt="" caption="A representação de um microsserviço versus um monólito (Fowler, 2015)" />
...
<Figure src={figureImage2} alt="" wide />
...
<Figure src={figureImage3} alt="" caption="Especificação de um pod do Kubernetes" />
...
<Figure src={figureImage4} alt="" caption="Explicação de um tráfego norte-sul para um leste-oeste" wide />
...
<Figure src={figureImage5} alt="" caption="Visão geral da arquitetura de um Service Mesh" />
...
<Figure src={figureImage6} alt="" caption="Imagem do dashboard do Linkerd" />
