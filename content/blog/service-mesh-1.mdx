...
heroImage: "./service-mesh-1/photo-1545987796-200677ee1011-4fe94fa4.jpg"
draft: false
visibility: "public"
---
...
<Figure src="./service-mesh-1/image-8.png" alt="" caption="A representação de um microsserviço versus um monólito (Fowler, 2015)" />
...
<Figure src="./service-mesh-1/image-10.png" alt="" wide />
...
<Figure src="./service-mesh-1/image-12.png" alt="" caption="Especificação de um pod do Kubernetes" />
...
<Figure src="./service-mesh-1/image-14.png" alt="" caption="Explicação de um tráfego norte-sul para um leste-oeste" wide />
...
<Figure src="./service-mesh-1/image-13.png" alt="" caption="Visão geral da arquitetura de um Service Mesh" />
...
<Figure src="./service-mesh-1/image-15.png" alt="" caption="Imagem do dashboard do Linkerd" />
...
Nos próximos artigos vamos explorar ainda mais como podemos criar e manipular service meshes e também seus conceitos! Por isso se [inscreva na newsletter](/signup?utm_source=imasters&utm_medium=article&utm_campaign=behavioral_patterns) para receber notícias semanais de todos os artigos e também outras notícias do mundo da tecnologia!
