...
Finally, we have the well-known `forEach()` method, which basically does what the analogous `Array` method does.[^n1]
...
[^n1]: Remember that we don't have keys as strings here.
