...
Por fim, temos o já conhecido método `forEach()`, que basicamente faz a mesma coisa que o método análogo do `Array`.<MarginNote>Lembre-se que aqui a gente não tem as chaves como strings.</MarginNote>
