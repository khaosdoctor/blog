...
Por fim, temos o já conhecido método `forEach()`, que basicamente faz a mesma coisa que o método análogo do `Array`.[^n1]
...
[^n1]: Lembre-se que aqui a gente não tem as chaves como strings.
