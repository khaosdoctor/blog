...
Tudo isso é muito bonito, mas o que são os mocks e para que a gente usaria algo assim?<Sidenote>Eu não vou entrar no conceito do que são mocks aqui em detalhe, mas você pode entender mais sobre eles nesse [artigo](https://medium.com/trainingcenter/testes-unit%C3%A1rios-mocks-stubs-spies-e-todas-essas-palavras-dif%C3%ADceis-f2765ac87cc8) (antigo, porém relevante)</Sidenote>
