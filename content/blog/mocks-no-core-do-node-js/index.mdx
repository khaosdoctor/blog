...
Tudo isso é muito bonito, mas o que são os mocks e para que a gente usaria algo assim?[^n1]
...
[^n1]: Eu não vou entrar no conceito do que são mocks aqui em detalhe, mas você pode entender mais sobre eles nesse [artigo](https://medium.com/trainingcenter/testes-unit%C3%A1rios-mocks-stubs-spies-e-todas-essas-palavras-dif%C3%ADceis-f2765ac87cc8) (antigo, porém relevante)

[^n2]: Eu não vou colocar essa implementação da PriorityQueue aqui, mas o [link](https://github.com/nodejs/node/pull/48638/files#diff-21786c167d9eed3034877e03e9bc8640bf6bcf2b7c5b33980226d76e3a69d4bdR41-R44) acima vai te levar pra lá
