...
heroImage: "./executando-containers-no-azure-container-instancies-com-docker/build-a-docker-swarm-cluster-on-azure-1-638.jpg"
draft: false
visibility: "public"
---

import figureImage1 from './executando-containers-no-azure-container-instancies-com-docker/image-9.png'
import figureImage2 from './executando-containers-no-azure-container-instancies-com-docker/image-10.png'
import figureImage3 from './executando-containers-no-azure-container-instancies-com-docker/image-11.png'
import figureImage4 from './executando-containers-no-azure-container-instancies-com-docker/image-12.png'
import figureImage5 from './executando-containers-no-azure-container-instancies-com-docker/image-13.png'
...
<YouTube id="wsDC5tXR7QA" caption="Vídeo do Code In Quarentena sobre como fazer um deploy no ACI" />
...
<Figure src={figureImage1} priority alt="" caption="Imagem mostrando a página principal de preferências do Docker Edge" />

Veja na aba `Command Line` se você possui a opção `Enable Cloud Experience` ativada:

<Figure src={figureImage2} alt="" caption="Imagem mostrando a opção &quot;Enable Cloud Experience&quot; ativa nas ferramentas do Docker" />
...
<Figure src={figureImage3} alt="" caption="Imagem mostrando o browser acessando o IP anterior e o resultado da API com a frase &quot;Hello World&quot;" />

Veja que, se acessarmos o portal da Azure, vamos ter o nosso recurso criado como se tivéssemos criado manualmente!

<Figure src={figureImage4} alt="" caption="Imagem do portal da Azure com o nosso recurso &quot;node-api&quot; criado" />
...
<Figure src={figureImage5} alt="" caption="Site da DockerCon no ar utilizando a integração com ACI" />
