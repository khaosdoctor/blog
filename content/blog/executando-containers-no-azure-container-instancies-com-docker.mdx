...
<Figure src="./executando-containers-no-azure-container-instancies-com-docker/image-9.png" alt="" caption="Imagem mostrando a página principal de preferências do Docker Edge" />

Veja na aba `Command Line` se você possui a opção `Enable Cloud Experience` ativada:

<Figure src="./executando-containers-no-azure-container-instancies-com-docker/image-10.png" alt="" caption="Imagem mostrando a opção &quot;Enable Cloud Experience&quot; ativa nas ferramentas do Docker" />
...
<Figure src="./executando-containers-no-azure-container-instancies-com-docker/image-11.png" alt="" caption="Imagem mostrando o browser acessando o IP anterior e o resultado da API com a frase &quot;Hello World&quot;" />

Veja que, se acessarmos o portal da Azure, vamos ter o nosso recurso criado como se tivéssemos criado manualmente!

<Figure src="./executando-containers-no-azure-container-instancies-com-docker/image-12.png" alt="" caption="Imagem do portal da Azure com o nosso recurso &quot;node-api&quot; criado" />
...
<Figure src="./executando-containers-no-azure-container-instancies-com-docker/image-13.png" alt="" caption="Site da DockerCon no ar utilizando a integração com ACI" />
