...
import figureImage1 from './aplicando-two-factor-authentication-no-ssh/Screen-Shot-2020-11-05-at-18.26.59.png'
...
<Figure src={figureImage1} priority alt="" caption="Resultado da criação de um autenticador" />
