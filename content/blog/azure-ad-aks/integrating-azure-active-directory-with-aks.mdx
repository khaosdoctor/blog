...
Let's add a new user called Alice to the group we just created, and copy her ObjectID as we create her:
...
Now let's create the binding of this role to our AD group's ID:
