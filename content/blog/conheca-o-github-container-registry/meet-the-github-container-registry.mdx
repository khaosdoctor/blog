...
We've [already talked in another article](https://dev.to/azure/do-zero-a-automacao-em-7-minutos-com-github-actions-1386) about how we can automate a bunch of things using GH Actions.<Sidenote>And more articles are coming 😎</Sidenote> So how do we use actions to push our images to GitHub's CR?
