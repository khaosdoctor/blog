...
lang: pt
category: technology
tags: ["docker", "containers", "github", "development", "technology", "infrastructure"]
...
Já falamos [em outro artigo](https://dev.to/azure/do-zero-a-automacao-em-7-minutos-com-github-actions-1386) sobre como podemos automatizar uma série de coisas utilizando GH Actions.[^n1] Então como podemos utilizar as actions para enviar nossas imagens para o CR do GitHub?
...
[^n1]: E mais artigos vão vir por ai 😎
