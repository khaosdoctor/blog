...
<Figure src="./v8-sparkplug/image.png" alt="" caption="Um fluxograma do fluxo de código do V8" />
...
<Figure src="./v8-sparkplug/image-1.png" alt="" caption="A nova pipeline simplificada" />
