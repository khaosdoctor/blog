...
heroImage: "./o-guia-do-grpc-2/1_EClgy6MmfsW6EDOD2NPigQ.png"
draft: false
visibility: "public"
...
> Se você quiser saber mais sobre a integração do Node com o C++ e como tudo funciona por baixo dos panos, eu tenho uma [série de 10 partes sobre os internals do Node.js](https://dev.to/khaosdoctor/node-js-por-baixo-dos-panos-1-conhecendo-nossas-ferramentas-34b6) que recomendo a leitura.
...
> Se você quiser saber um pouco mais sobre como ele funciona, [este artigo do Mark Kose](https://medium.com/@Mark.io/how-to-get-a-browser-communicate-with-containerd-using-grpc-fd44f7cf7512) tem um bom overview de como uma comunicação deste tipo pode ser feita.
...
![Uma chamada gRPC feita a partir do browser mostrando a URL e as informações de requisição](./o-guia-do-grpc-2/image-14.png)
...
![Diagramação dos bits da request](./o-guia-do-grpc-2/image-15.png)
...
> Veja o script `compile` dentro [do arquivo package no repositório deste projeto](https://github.com/khaosdoctor/grpc-guide-part2-javascript-sample/blob/main/package.json#L8) para entender como podemos compilar os arquivos e como eles ficam depois de compilados.
