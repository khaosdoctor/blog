...
**_Qual é a sua opinião sobre_** [**_solopreneurs_**](https://canaltech.com.br/empreendedorismo/o-que-e-solopreneur-191530/) **_e essa galera coach de sucesso?_**
...
[^n1]: Muito desse "glamour" do mundo dev vem da galera do "minha rotina trabalhando na \<FAANG aqui>", vendendo um sonho que não é real.

[^n2]: Claro, não são todas as pessoas, existem excelentes influenciadores que conseguem ensinar algo bom e engajar a galera, mas são raros.

[^n3]: Que fez um comeback recentemente, aparentemente redimido, mas eu duvido muito, mesmo que ferramentas como a [DeepWiki](https://deepwiki.com/) sejam relativamente boas de usar
