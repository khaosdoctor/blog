...
lang: pt
category: technology
tags: ["cloud", "containerd", "containers", "cri", "devops", "docker", "kubernetes", "microservices", "oci", "technology", "cri-o", "infrastructure"]
...
![](./image-41.png "Modelo de funcionamento do Docker (Fonte: Docker)")
...
![](./image-44.png "Processo de uso do CRI-O dentro do Kubernetes (Fonte: CRI-O)")
