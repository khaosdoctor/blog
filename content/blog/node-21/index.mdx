...
Atualmente a implementação permite abrir e fechar conexões, além de enviar dados. Ela disponibiliza quatro eventos: `open`, `close`, `message` e `error`. E isso é incrível porque a gente logo mais não vai mais precisar utilizar implementações como o Socket.io para poder fazer com que aplicações se comuniquem em canais bidirecionais.<MarginNote>Além disso essa discussão [está no ar desde 2018](https://github.com/nodejs/node/issues/19308)</MarginNote>
