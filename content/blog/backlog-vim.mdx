...
<Figure src="./backlog-vim/gloom-contrast-9021c959.png" alt="GitHub - rainglow/atom: 320+ color themes for Atom." caption="<span style=&quot;white-space: pre-wrap;&quot;>Screenshot do falecido Atom, o precursor do VSCode</span>" />
...
<Figure src="./backlog-vim/image.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Nvim rodando um projeto com Deno</span>" />
...
<Figure src="./backlog-vim/image-1.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Telescope.nvim no modo de inserção</span>" />
...
<Figure src="./backlog-vim/image-2.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Telescope.nvim no modo normal</span>" />
...
<Figure src="./backlog-vim/image-3.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Captura de tela do ripgrep</span>" />
...
<Figure src="./backlog-vim/image-6.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Se você perdeu alguma tecla, pode buscar aqui</span>" />

Além disso o pacote `whichkey` mostra todas as combinações possíveis de uma tecla pressionada:

<Figure src="./backlog-vim/image-7.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Exemplo de teclas possíveis com &lt;leader&gt; pressionado</span>" />
...
<Figure src="./backlog-vim/image-4.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Overrides para o Neotree</span>" />
...
<Figure src="./backlog-vim/image-5.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Função para distinguir Deno de Node</span>" />
...
<Figure src="./backlog-vim/image-9.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Replace inline com regex</span>" />
...
<Figure src="./backlog-vim/image-11.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Registradores no LazyVim</span>" />
...
<Figure src="./backlog-vim/image-12.png" alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Lista de marcas automáticas</span>" />
