...
import figureImage1 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image.png'
import figureImage2 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image-1.png'
import figureImage3 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image-2.png'
import figureImage4 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image-3.png'
import figureImage5 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image-4.png'
import figureImage6 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image-5.png'
import figureImage7 from './faca-codigo-em-qualquer-lugar-com-os-codespaces/image-6.png'
...
<Figure src={figureImage1} priority alt="" caption="Tela de abertura do site do GitHub Codespaces" wide />
...
<Figure src={figureImage2} alt="" caption="Tela de clonagem de um repositório do GitHub mostrando o botão &quot;Open with Codespaces&quot;" />
...
<Figure src={figureImage3} alt="" caption="Tela de abertura do Visual Studio Codespaces" wide />
...
<Figure src={figureImage4} alt="" caption="Botão de criação para um Visual Studio Codespace" />
...
<Figure src={figureImage5} alt="" caption="Tela de opções do Visual Studio Codespaces" />
...
<Figure src={figureImage6} alt="" caption="Visual Studio Codespace online" />
...
<Figure src={figureImage7} alt="" caption="Abrindo um novo repositório com codespace" />
