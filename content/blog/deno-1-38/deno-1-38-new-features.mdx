...
This video from the Deno team shows how well this feature helps with development:

<Video src="/videos/deno-1-38/deno-hmr.mp4" poster="https://img.spacergif.org/v1/1440x626/0a/spacer.png" />

Notice that as the increment number changes, the application already picks up the result and starts applying the new change without needing to restart the entire app.
