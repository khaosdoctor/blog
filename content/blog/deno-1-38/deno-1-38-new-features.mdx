...
This video from the Deno team shows how well this feature helps with development:<Sidenote>Notice that as the increment number changes, the application already picks up the result and starts applying the new change without needing to restart the entire app.</Sidenote>
