...
Available since TypeScript 4.9, it's also a feature described in the [original decorators proposal](https://github.com/tc39/proposal-decorators).<MarginNote>We've actually talked about decorators [here](/javascript-decorators/).</MarginNote>
