...
Available since TypeScript 4.9, it's also a feature described in the [original decorators proposal](https://github.com/tc39/proposal-decorators).[^n1]
...
[^n1]: We've actually talked about decorators [here](/javascript-decorators/).
