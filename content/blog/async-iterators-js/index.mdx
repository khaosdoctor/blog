...
Agora podemos utilizar ele normalmente, com `for (const x of iterable)` e teremos todos os valores do `array` sendo iterador um a um.[^n1]
...
[^n1]: Se você quiser saber um pouco mais sobre **Symbols**, dê uma olhada [neste outro artigo que escrevi só sobre o tema](https://medium.com/trainingcenter/javascript-symbols-decifrando-o-mist%C3%A9rio-383e359e64e3).
