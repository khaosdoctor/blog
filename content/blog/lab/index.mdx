...
### Escolha o tamanho da régua

Cada bloco abaixo é a mesma `---`, com um comprimento diferente. O vencedor virá `--rule-length` em `theme.css` e o resto deste bloco sai.
...
E o mesmo comprimento com pesos e brilhos diferentes:

<div data-v="rule-thin">
...
### Escolha o tratamento da citação

Cinco alternativas ao cartão padrão acima, cada uma usando uma combinação diferente de fundo, moldura, marca d'água, capitular e itálico. A escolhida vira o padrão e as outras saem.

<div data-v="quote-a">

**A — roxo sólido, texto branco, só itálico**
...
**B — roxo bem diluído, texto normal, capitular**
...
**C — moldura dupla ANSI, sem fundo, monoespaçada**
...
**E — abertura discreta, sem cartão e sem autoria**
