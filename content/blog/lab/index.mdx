...
import Counter from '../../../src/components/lab/Counter.vue'
...
A linha de `import` no topo é a única exceção: ela existe porque a ilha interativa do final precisa de uma importação real. Nenhum post normal importa nada, porque todos os componentes já são injetados em todos os posts.
...
### Escolha a cor e a densidade da régua

A régua agora tem 150px, 1px de espessura, pontilhada, sem brilho, e desaparece nas duas pontas. O que falta escolher é a cor. Cada bloco abaixo é a mesma `---` com um valor diferente; o vencedor virá `--rule-core` em `theme.css` e o resto deste bloco sai.

<div data-v="rule-fg-80">

**texto a 80% (padrão atual)**

---

</div>

<div data-v="rule-fg-60">
...
**vermelho da marca a 80%**

---

</div>

<div data-v="rule-yellow">

**amarelo da marca a 80%**

---

</div>

<div data-v="rule-blue">
...
E a mesma cor com outro ritmo de pontos, mais a versão sólida:

<div data-v="rule-tight">
...
### Escolha como a régua do autor é desenhada

O tratamento escolhido é a moldura dupla ANSI: sem preenchimento, corpo monoespaçado, moldura viva. O que falta decidir é a régua que separa a citação do autor. As oito variações abaixo são idênticas em tudo, menos nisso.

<div data-v="quote-dotted-both">

**pontilhada, apagando nas duas pontas**
...
<div data-v="quote-dotted-right">

**pontilhada, apagando só à direita**
...
<div data-v="quote-dotted-left">

**pontilhada, apagando só à esquerda**
...
<div data-v="quote-dotted-none">

**pontilhada, sem apagar**
...
<div data-v="quote-solid-both">

**sólida, apagando nas duas pontas**
...
<div data-v="quote-solid-right">

**sólida, apagando só à direita**
...
<div data-v="quote-solid-left">

**sólida, apagando só à esquerda**
...
Este é o único lugar onde uma linha de `import` está certa em um post, porque uma diretiva de cliente precisa de uma importação real do componente. `client:visible` significa que o JavaScript do contador só é baixado quando ele entra na tela; o resto da página continua sendo HTML estático.
...
Some, subtraia, zere, e navegue pelos três botões com Tab e Espaço para confirmar que a ilha hidratou.
