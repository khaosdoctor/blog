...
![](./image.png "Tela de abertura do site do GitHub Codespaces")
...
![](./image-1.png 'Tela de clonagem de um repositório do GitHub mostrando o botão "Open with Codespaces"')
...
![](./image-2.png "Tela de abertura do Visual Studio Codespaces")
...
![](./image-3.png "Botão de criação para um Visual Studio Codespace")
...
![](./image-4.png "Tela de opções do Visual Studio Codespaces")
...
![](./image-6.png "Abrindo um novo repositório com codespace")
