...
lang: pt
category: technology
tags: ["kubernetes", "containers", "linkerd", "architecture", "technology", "development", "cloud", "infrastructure"]
...
[^n1]: Você também pode utilizar soluções para executar o K8S de forma local com o [minikube](https://kubernetes.io/docs/tasks/tools/install-minikube/), [Docker](https://www.docker.com/products/docker-desktop) ou [outras opções](https://kubernetes.io/docs/setup/)
