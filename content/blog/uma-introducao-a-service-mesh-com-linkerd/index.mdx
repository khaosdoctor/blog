...
Para realizar esse hands on eu vou criar um cluster no [AKS](https://docs.microsoft.com/azure/aks/?WT.mc_id=personal-blog-ludossan), mas você pode escolher realizar em qualquer cluster Kubernetes que você tiver, **inclusive em um cluster já em produção** visto que o Linkerd não é destrutivo e instala suas informações em outro namespace.<Sidenote>Você também pode utilizar soluções para executar o K8S de forma local com o [minikube](https://kubernetes.io/docs/tasks/tools/install-minikube/), [Docker](https://www.docker.com/products/docker-desktop) ou [outras opções](https://kubernetes.io/docs/setup/)</Sidenote>
