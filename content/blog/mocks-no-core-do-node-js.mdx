...
heroImage: "./mocks-no-core-do-node-js/articles--1--2.png"
draft: false
visibility: "public"
seoTitle: "Implementando Date Mocks no Node Test Runner: Uma História"
---

import figureImage1 from './mocks-no-core-do-node-js/image.png'
import figureImage2 from './mocks-no-core-do-node-js/image-8.png'
import figureImage3 from './mocks-no-core-do-node-js/image-7.png'
...
> Eu não vou entrar no conceito do que são mocks aqui em detalhe, mas você pode entender mais sobre eles nesse [artigo](https://medium.com/trainingcenter/testes-unit%C3%A1rios-mocks-stubs-spies-e-todas-essas-palavras-dif%C3%ADceis-f2765ac87cc8) (antigo, porém relevante)
...
<Figure src={figureImage1} priority alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>a PR original do Erick</span>" />
...
![](./mocks-no-core-do-node-js/image-1.png)
...
![](./mocks-no-core-do-node-js/image-4.png)
...
![](./mocks-no-core-do-node-js/image-5.png)
...
> Eu não vou colocar essa implementação da PriorityQueue aqui, mas o [link](https://github.com/nodejs/node/pull/48638/files#diff-21786c167d9eed3034877e03e9bc8640bf6bcf2b7c5b33980226d76e3a69d4bdR41-R44) acima vai te levar pra lá
...
<Figure src={figureImage2} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Dá pra ver que eu estava bem feliz</span>" />
...
<Figure src={figureImage3} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Eu estava ficando maluco já</span>" />
