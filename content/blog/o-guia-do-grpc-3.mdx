...
heroImage: "./o-guia-do-grpc-3/js-ts.png"
draft: false
visibility: "public"
...
> Todos os tipos que estamos usando na chamada anterior, como o `ServerUnaryCall` e o `sendUnaryData` são [provenientes do `@grpc/grpc-js` nativamente](https://github.com/grpc/grpc-node/blob/master/packages/grpc-js/src/server-call.ts#L84-L86), já que a lib é escrita em TypeScript, veja mais dos tipos [no repositório oficial](https://github.com/grpc/grpc-node/blob/master/packages/grpc-js/src).
...
![Bulbo de luz azul mostrando a opção automática de implementação da interface no VSCode](./o-guia-do-grpc-3/image-5.png)

Ao clicar, você terá as interfaces implementadas com os tipos necessários, basta substituir pela implementação real:

![Classe pré implementada com métodos genéricos](./o-guia-do-grpc-3/image-6.png)
