...
<Figure src="./deploy-de-imagens-docker-do-vscode-para-a-azure/container-use.png" alt="Selecione o contexto que vamos operar" caption="Use o contexto criado" />
...
<Figure src="./deploy-de-imagens-docker-do-vscode-para-a-azure/docker-login.png" alt="Clique no botão de conexão para fazer o login" caption="Clique no botão de conexão para logar em um registro" />

A partir daí podemos selecionar o tipo de registro que estamos usando

<Figure src="./deploy-de-imagens-docker-do-vscode-para-a-azure/type-cr.png" alt="Selecione o serviço" caption="Selecione o tipo de CR que quer logar" />

E então teremos a listagem das nossas imagens hospedadas nestes serviços:

<Figure src="./deploy-de-imagens-docker-do-vscode-para-a-azure/docker-images.png" alt="Veja as imagens" caption="Veja as imagens listadas" />
...
<Figure src="./deploy-de-imagens-docker-do-vscode-para-a-azure/deploy.png" alt="" caption="Selecione a imagem e faça o deploy" />
