...
heroImage: "./deploy-de-imagens-docker-do-vscode-para-a-azure/build-a-docker-swarm-cluster-on-azure-1-638.jpg"
draft: false
visibility: "public"
---

import figureImage1 from './deploy-de-imagens-docker-do-vscode-para-a-azure/container-use.png'
import figureImage2 from './deploy-de-imagens-docker-do-vscode-para-a-azure/docker-login.png'
import figureImage3 from './deploy-de-imagens-docker-do-vscode-para-a-azure/type-cr.png'
import figureImage4 from './deploy-de-imagens-docker-do-vscode-para-a-azure/docker-images.png'
import figureImage5 from './deploy-de-imagens-docker-do-vscode-para-a-azure/deploy.png'
...
<Figure src="https://github.com/microsoft/vscode-docker/raw/master/resources/readme/overview.gif" alt="" caption="Baixe e instale a extensão do Docker" wide />
...
<Figure src={figureImage1} priority alt="Selecione o contexto que vamos operar" caption="Use o contexto criado" />
...
<Figure src={figureImage2} alt="Clique no botão de conexão para fazer o login" caption="Clique no botão de conexão para logar em um registro" />

A partir daí podemos selecionar o tipo de registro que estamos usando

<Figure src={figureImage3} alt="Selecione o serviço" caption="Selecione o tipo de CR que quer logar" />

E então teremos a listagem das nossas imagens hospedadas nestes serviços:

<Figure src={figureImage4} alt="Veja as imagens" caption="Veja as imagens listadas" />
...
<Figure src={figureImage5} alt="" caption="Selecione a imagem e faça o deploy" />

Veja o processo como um todo:

<Figure src="https://azurecomcdn.azureedge.net/mediahandler/acomblog/media/Default/blog/9b424351-84c1-4f45-b23f-e34a18d24a9f.gif" alt="" wide />
