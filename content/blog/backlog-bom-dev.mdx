...
heroImage: "./backlog-bom-dev/articles-2.png"
draft: false
visibility: "public"
seoTitle: "É possível medir eficiência em tecnologia?"
---

import figureImage1 from './backlog-bom-dev/DraggedImage.png'
import figureImage2 from './backlog-bom-dev/DraggedImage-1.png'
...
<Figure src={figureImage1} priority alt="Tabela mostrando o custo de &quot;engenheiros fantasma&quot;" caption="<span style=&quot;white-space: pre-wrap;&quot;>Tabela mostrando o custo de &quot;engenheiros fantasma&quot;</span>" />
...
<Figure src={figureImage2} alt="Em média, os engenheiros fracos entregam 2 a 3 commits por mês" caption="<span style=&quot;white-space: pre-wrap;&quot;>Em média, os engenheiros fracos entregam 2 a 3 commits por mês</span>" />
...
![](./backlog-bom-dev/logo-2-corte.png)
...
![](./backlog-bom-dev/DraggedImage-2.png)
...
![](./backlog-bom-dev/DraggedImage-3.png)
