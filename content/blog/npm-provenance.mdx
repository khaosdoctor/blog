...
heroImage: "./npm-provenance/articles.png"
draft: false
visibility: "public"
---

import figureImage1 from './npm-provenance/image.png'
...
<Figure src={figureImage1} priority alt="" caption="Imagem representando o fluxo dessas operações (Fonte: NPM)" />
...
Para gerar o seu próprio arquivo de provenance, o NPM criou uma flag chamada `--provenance`, então basta rodar `npm publish --provenance` que o seu pacote vai ser assinado.

> Dá uma olhada [na documentação](https://docs.npmjs.com/generating-provenance-statements) também que existe bastante coisa interessante lá
