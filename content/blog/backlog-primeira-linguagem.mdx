...
heroImage: "./backlog-primeira-linguagem/articles.png"
draft: false
visibility: "public"
---

import figureImage1 from './backlog-primeira-linguagem/image-3.png'
import figureImage2 from './backlog-primeira-linguagem/image-4.png'
import figureImage3 from './backlog-primeira-linguagem/image-13.png'
import figureImage4 from './backlog-primeira-linguagem/image-6.png'
import figureImage5 from './backlog-primeira-linguagem/image-1.png'
import figureImage6 from './backlog-primeira-linguagem/image-5.png'
import figureImage7 from './backlog-primeira-linguagem/image-9.png'
import figureImage8 from './backlog-primeira-linguagem/image-2.png'
import figureImage9 from './backlog-primeira-linguagem/image-7.png'
import figureImage10 from './backlog-primeira-linguagem/image-8.png'
import figureImage11 from './backlog-primeira-linguagem/image-10.png'
...
<Figure src="https://upload.wikimedia.org/wikipedia/commons/f/f8/Loom.jpg" alt="The punched-card control mechanism of a Jacquard loom in use in 2009, Varanasi, Uttar Pradesh, India." caption="<span style=&quot;white-space: pre-wrap;&quot;>Ironicamente, os cartões eram costurados juntos</span>" />
...
<Figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Telar_manual_y_m%C3%A1quina_de_Jacquard_12.jpg/1280px-Telar_manual_y_m%C3%A1quina_de_Jacquard_12.jpg" alt="Manual loom with double width and Jacquard loom, Colegio del Arte Mayor de la Seda of Valencia." caption="<span style=&quot;white-space: pre-wrap;&quot;>Um tear com o &quot;plugin&quot; de Jacquard</span>" />
...
<Figure src={figureImage1} priority alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Charles Babbage</span>" />
...
<Figure src={figureImage2} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Uma construção do que seria o motor analítico</span>" />
...
<Figure src="https://upload.wikimedia.org/wikipedia/commons/f/f9/Ada_Byron_daguerreotype_by_Antoine_Claudet_1843_or_1850_-_cropped_%28cropped%29.png" alt="Augusta Ada King, Countess of Lovelace, daguerrotype portrait circa 1843" caption="<span style=&quot;white-space: pre-wrap;&quot;>Ada Lovelace em sua única &quot;fotografia&quot;, tirada em 1843</span>" />
...
<Figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Diagram_for_the_computation_of_Bernoulli_numbers.jpg/1280px-Diagram_for_the_computation_of_Bernoulli_numbers.jpg" alt="undefined" caption="<span style=&quot;white-space: pre-wrap;&quot;>A nota G</span>" />
...
![](./backlog-primeira-linguagem/logo-2-corte.png)

Aproveitando o fim do ano, muita gente tá planejando viagens ou começando a vida fora do país, né? Então olha essa promoção exclusiva de férias:

-   **1GB de dados grátis** com um e-chip pra usar no exterior;
-   **35% de desconto no seguro viagem** (que a gente sabe que pesa no bolso).

Pra garantir, é só abrir sua conta global na Remessa e carregar com pelo menos 200 Euros ou Dólares até 31/01/2025. Além de conectividade, ainda rola a menor taxa do mercado pra transferências!

Use o cupom **LSANTOSDEV5** e aproveite.

👉 [Clica aqui pra transferir com a menor taxa do mercado!](https://lsantos.dev/ferias-remessa)
...
💙 **Apoie o meu trabalho**: Se você gosta do conteúdo e quer dar uma força, mesmo com apenas R$1, isso já faz toda a diferença! [Clique aqui](https://github.com/sponsors/khaosdoctor)!
...
<Figure src={figureImage3} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>O Zuse Z3, o primeiro computador digital do mundo</span>" />
...
<Figure src="https://linube.com/blog/wp-content/uploads/primer-lenguaje-programacion-1280x720.jpg" alt="Primer lenguaje de programación: Plankalkül - Blog de Linube" caption="<span style=&quot;white-space: pre-wrap;&quot;>Um programa em plankalkül</span>" />
...
<Figure src={figureImage4} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Árvore das linguagens de programação (</span><a href=&quot;https://www.levenez.com/lang/lang.pdf&quot;><span style=&quot;white-space: pre-wrap;&quot;>https://www.levenez.com/lang/lang.pdf</span></a><span style=&quot;white-space: pre-wrap;&quot;>)</span>" />
...
<Figure src={figureImage5} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Um programa em autocode para calcular uma função cúbica</span>" />
...
<Figure src="https://upload.wikimedia.org/wikipedia/commons/b/b2/John_Backus_2.jpg" alt="undefined" caption="<span style=&quot;white-space: pre-wrap;&quot;>John Backus em 1977</span>" />
...
<Figure src={figureImage6} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Um formulário para codar FORTRAN</span>" />
...
<Figure src={figureImage7} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Um cartão FORTRAN com um statement</span>" />
...
<Figure src={figureImage8} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Um programa em FORTRAN II</span>" />
...
<Figure src={figureImage9} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>O mesmo programa do FORTRAN II em FORTRAN 66</span>" />
...
<Figure src={figureImage10} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>O mesmo programa do FORTRAN 66 em FORTRAN 77</span>" />
...
<Figure src={figureImage11} alt="" caption="<span style=&quot;white-space: pre-wrap;&quot;>Computação da velocidade e temperatura em oceanos usando NEMO (em FORTRAN)</span>" />
...
<Bookmark url="https://github.com/fortran-gaming?utm_source=chatgpt.com" title="Fortran Gaming" description="Modern and resurrected Fortran games. Includes candidates for conversion to Fortran in other languages. - Fortran Gaming" />
...
<Bookmark url="https://www.levenez.com/lang/" title="Computer Languages History" description="A Computer Languages diagram" publisher="Éric Lévénez" />
