...
heroImage: "./typescript-55/articles.png"
draft: false
visibility: "public"
...
O TS agora vai suportar os novos métodos dos Sets que vieram no [ECMAScript 2024](/novos-metodos-set/) mesmo que eles ainda não tenham sido completamente implementados. Não vou dar detalhes aqui porque você pode ver no artigo que eu linkei que tem todas as explicações sobre cada método.
