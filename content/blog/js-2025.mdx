...
Vamos ver se essas previsões se mantém reais, se você tem opiniões diferentes, não esqueça de comentar lá nas minhas [redes](https://lsantos.dev) ou me chamar lá no [X](twitter.lsantos.dev) pra trocar uma ideia!
