...
import figureImage1 from './veja-o-que-ha-de-novo-no-node-js-16/image-4.png'
...
<Figure src={figureImage1} priority alt="" caption="Calendário de releases do Node.js mostrando a versão 16 como current" />
