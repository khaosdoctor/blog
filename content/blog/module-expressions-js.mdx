...
heroImage: "./module-expressions-js/Blog-cover-Template.png"
draft: false
visibility: "public"
seoTitle: "O que são Module Expressions no JavaScript"
---

import figureImage1 from './module-expressions-js/image-1.png'
import figureImage2 from './module-expressions-js/image-2.png'
...
<Figure src={figureImage1} priority alt="" caption="O código é passado de uma thread a outra através de string ou BLOB" />
...
<Figure src={figureImage2} alt="" caption="Agora o módulo não troca de tipo e nem perde contexto" />
