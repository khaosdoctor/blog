...
<Figure src="./module-expressions-js/image-1.png" alt="" caption="O código é passado de uma thread a outra através de string ou BLOB" />
...
<Figure src="./module-expressions-js/image-2.png" alt="" caption="Agora o módulo não troca de tipo e nem perde contexto" />
