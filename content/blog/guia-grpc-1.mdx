...
import figureImage1 from './guia-grpc-1/image-6.png'
import figureImage2 from './guia-grpc-1/image-5.png'
import figureImage3 from './guia-grpc-1/image-9.png'
import figureImage4 from './guia-grpc-1/image-10.png'
import figureImage5 from './guia-grpc-1/image-11.png'
import figureImage6 from './guia-grpc-1/image-8.png'
...
<YouTube id="5RVRbDHFhNw" caption="Meu vídeo sobre gRPC apresentado pelo HackBuddy" />
...
<Figure src={figureImage1} priority alt="" caption="Diagrama de funcionamento do RPC" />
...
<Figure src={figureImage2} alt="" caption="Diagrama de um serviço gRPC" />
...
<Figure src={figureImage3} alt="" caption="História do HTTP ao longo das décadas" />
...
<Figure src={figureImage4} alt="" caption="Binary framing em ação" />
...
<Figure src={figureImage5} alt="" caption="Compressão de headers em funcionamento" />
...
<Figure src={figureImage6} alt="" caption="Diagrama do encoding do protobuf" />
