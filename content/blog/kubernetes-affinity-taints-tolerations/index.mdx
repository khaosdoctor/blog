...
lang: pt
category: technology
tags: ["kubernetes", "aks", "azure", "cloud", "containers", "development", "devops", "docker", "technology", "infrastructure"]
...
Neste artigo vamos aprender a controlar nossos nós com seletores, vamos aprender o conceito de **Node Pools** e também o conceito de **Node Affinity**. Por fim vamos entender todo a ideia por trás de **taints e tolerations**. E, com isso, vamos aprender a ter o controle completo do nosso cluster e de onde queremos nossas aplicações.[^n1]
