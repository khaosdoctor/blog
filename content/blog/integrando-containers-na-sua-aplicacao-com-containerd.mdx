...
heroImage: "./integrando-containers-na-sua-aplicacao-com-containerd/external-content.duckduckgo-2.jpg"
draft: false
visibility: "public"
---

import figureImage1 from './integrando-containers-na-sua-aplicacao-com-containerd/image-7.png'
import figureImage2 from './integrando-containers-na-sua-aplicacao-com-containerd/image-5.png'
import figureImage3 from './integrando-containers-na-sua-aplicacao-com-containerd/image-8.png'
import figureImage4 from './integrando-containers-na-sua-aplicacao-com-containerd/image-15.png'
...
<Figure src={figureImage1} priority alt="" caption="Overview do ecossistema do ContainerD (Fonte: ContainerD)" />
...
<Figure src={figureImage2} alt="" caption="Rodei uma pequena VM usando Linux em meu computador" />
...
![](./integrando-containers-na-sua-aplicacao-com-containerd/image-6.png)
...
<Figure src={figureImage3} alt="" caption="runc instalado e pronto para ser executado" />
...
![](./integrando-containers-na-sua-aplicacao-com-containerd/image-10.png)
...
![](./integrando-containers-na-sua-aplicacao-com-containerd/image-11.png)
...
![](./integrando-containers-na-sua-aplicacao-com-containerd/image-13.png)
...
![](./integrando-containers-na-sua-aplicacao-com-containerd/image-12.png)
...
> O código que você verá abaixo pode ser encontrado [neste repositório em meu GitHub](https://github.com/khaosdoctor/containerd-integration-example)
...
![](./integrando-containers-na-sua-aplicacao-com-containerd/image-14.png)
...
<Figure src={figureImage4} alt="" caption="Fluxo de execução completo" />

Se tentarmos acessar a API pelo browser dentro dos 10 segundos vamos obter o mesmo resultado que tivemos anteriormente:

![](./integrando-containers-na-sua-aplicacao-com-containerd/image-16.png)
