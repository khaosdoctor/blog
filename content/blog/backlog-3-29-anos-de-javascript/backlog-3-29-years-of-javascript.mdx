...
[^n1]: To give you an idea of how important Microsoft was at the time, it wasn't just the owner of the biggest (and almost only) OS used on over 90% of computers, it also owned nearly every language used to write programs for those computers.
