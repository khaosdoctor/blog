...
lang: pt
category: technology
tags: ["docker", "containerd", "oci", "cri", "kubernetes", "containers", "architecture", "technology", "infrastructure"]
...
![](./image.png "Diagrama de funcionamento do CRI")
...
![](./image-2.png "Diagrama de funcionamento do ContainerD com o Kubelet")
