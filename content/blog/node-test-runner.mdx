...
<Figure src="./node-test-runner/image-2.png" alt="" caption="Uma saída de erro do TAP melhorada" />

Quanto para sucessos:

<Figure src="./node-test-runner/image-3.png" alt="" caption="Uma saída de sucesso do TAP melhorada" />
