...
heroImage: "./harperdb-kubernetes/photo-1511447333015-45b65e60f6d5-405299ea.jpg"
draft: false
visibility: "public"
...
![The mounted Harper directory](./harperdb-kubernetes/2022-06-26-15-35-49-1.png)
...
![HarperDB Studio landing page](./harperdb-kubernetes/HarperDB-Studio.png)

Vamos criar uma instância local clicando no botão **Register User-installed Instance**:

![HDB Studio](./harperdb-kubernetes/2022-06-26-15-40-42.png)

Vamos preencher os detalhes da instância e, em seguida, clicar no botão **instance details**:

![HDB Studio registering an instance](./harperdb-kubernetes/2022-06-26-15-41-39.png)

Em seguida, selecionamos o nível gratuito e clicamos em Avançar:

![HDB Studio instance details](./harperdb-kubernetes/2022-06-26-15-42-07.png)

Confirme os termos de serviço e **Add Instance**. Você deve terminar com uma instância local do banco de dados:

![HDB Studio final instance created](./harperdb-kubernetes/2022-06-26-15-43-01.png)
...
![Azure-search-k8s](./harperdb-kubernetes/Azure-search-k8s.png)

Em seguida, clique no menu suspenso **create** e crie um novo cluster:

![Create-a-new-cluster](./harperdb-kubernetes/Create-a-new-cluster.png)
...
![AKS-Create-step-1](./harperdb-kubernetes/AKS-Create-step-1.png)
...
![AKS-Create-step-2](./harperdb-kubernetes/AKS-Create-step-2.png)

Clique no botão azul **Review+Create** para criar o cluster:

![AKS-Create-step-3](./harperdb-kubernetes/AKS-Create-step-3.png)
...
![HDB Resources](./harperdb-kubernetes/2022-06-26-18-04-00.png)
...
![Azure File Volume for PVC](./harperdb-kubernetes/Azure-File-volume.png)
...
![Connecting to our local instance in the cluster](./harperdb-kubernetes/HDB-Studio-K8S.png)
