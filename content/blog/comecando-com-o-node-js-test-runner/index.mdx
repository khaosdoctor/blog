...
Para saber se você tem tudo certo, é só rodar o comando `node --test` em uma pasta vazia.<Sidenote>O comando é recursivo, então ele vai tentar entrar em todas as suas pastas.</Sidenote> Como o node não vai encontrar nenhum arquivo, a sua saída deve ser essa:
