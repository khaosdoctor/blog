...
heroImage: "./conheca-o-github-container-registry/photo-1500313749317-0105e4b72ec1-7c8ef1f0.jpg"
draft: false
visibility: "public"
---

import figureImage1 from './conheca-o-github-container-registry/image-33.png'
import figureImage2 from './conheca-o-github-container-registry/image-45.png'
import figureImage3 from './conheca-o-github-container-registry/image-37.png'
import figureImage4 from './conheca-o-github-container-registry/image-40.png'
import figureImage5 from './conheca-o-github-container-registry/image-44.png'
...
<Figure src={figureImage1} priority alt="" caption="Acesse seu perfil para poder ver seus pacotes" />
...
![](./conheca-o-github-container-registry/image-34.png)

É importante que o token tenha as permissões de escrita e leitura de packages

<Figure src={figureImage2} alt="" caption="Tenha certeza que as permissões estão corretas" />
...
![](./conheca-o-github-container-registry/image-35.png)
...
![](./conheca-o-github-container-registry/image-46.png)

Depois, vamos na aba `actions` dentro do repositório:

![](./conheca-o-github-container-registry/image-36.png)
...
<Figure src={figureImage3} alt="" caption="Não vamos trabalhar com templates" />
...
![](./conheca-o-github-container-registry/image-39.png)

Iremos copiar o código clicando no botão de cópia do lado direito:

<Figure src={figureImage4} alt="" caption="Copiando o código de uso" />
...
<Figure src={figureImage5} alt="" caption="A nova imagem no nosso repositório, pronta para ser baixada" />
