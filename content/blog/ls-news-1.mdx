...
### [Como Chaos Engineering pode ser a diferença para um sistema resiliente](https://github.com/readme/featured/chaos-engineering)
...
### [Por que você não precisa de frameworks front-end](https://www.smashingmagazine.com/2022/05/you-dont-need-ui-framework/)
...
### [Por que nomear as coisas é tão difícil?](https://shekhargulati.com/2022/04/23/why-naming-stuff-is-hard/)
...
### [7 One-liners em JavaScript que são super úteis](https://tapajyoti-bose.medium.com/7-more-killer-one-liners-in-javascript-1cd180d82695)
...
### [O que devemos considerar quando integramos com sistemas de terceiros](https://shekhargulati.com/2022/02/16/factors-to-consider-when-architecting-systems-on-top-of-third-party-systems/)  
...
### [Jest é transferido para a OpenJS Foundation](https://engineering.fb.com/2022/05/11/open-source/jest-openjs-foundation/)
...
### [Ataques em cadeias de dependências podem ser o próximo problema do século](https://socket.dev/blog/inside-node-modules)
...
### [Tao of Node - O guia de Node para design, arquitetura e boas práticas](https://alexkondov.com/tao-of-node/)
...
Gostou dessa newsletter? Dê seu [feedback neste link](https://forms.gle/AmmtMAfQNGbotvSx9)
