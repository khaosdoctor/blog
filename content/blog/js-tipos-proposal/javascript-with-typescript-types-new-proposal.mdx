...
That said, field declarations inside classes using type annotations [are supported](https://github.com/giltayar/proposal-types-as-comments/#classes-as-type-declarations).<MarginNote>For a list of all supported types, take a look at [the official proposal](https://github.com/giltayar/proposal-types-as-comments/#type-annotations).</MarginNote>
