...
Both of these packages are loaders, they receive the files that will be loaded by the runtime and can perform actions on them, in our case, the action is to compile the file from TypeScript to JavaScript.<MarginNote>You can see more about this functionality in the [official documentation](https://nodejs.org/api/module.html#transpilation), including using the transpiling example itself.</MarginNote>
