...
Ambos esses pacotes são loaders, eles recebem os arquivos que serão carregados pelo runtime e podem realizar ações sobre eles, no nosso caso, a ação é compilar o arquivo de TypeScript para JavaScript.[^n1]
...
[^n1]: Você pode ver mais sobre essa funcionalidade [na documentação oficial](https://nodejs.org/api/module.html#transpilation), inclusive, usando o próprio exemplo da transpilação.
