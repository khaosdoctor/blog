...
### [O que são RFCs e por que você deveria usar](https://newsletter.pragmaticengineer.com/p/software-engineering-rfc-and-design)
...
### [O que todo dev deveria saber](https://github.com/mtdvio/every-programmer-should-know)
...
### [Melhores práticas para aplicações em escala](https://merge.dev/blog/engineering/how-to-stop-being-rate-limited-best-practices-for-making-api-calls-at-scale/)
...
### [As sete funções de um CTO](https://oded.substack.com/p/the-7-roles-of-a-cto)
...
### [Os três pilares do DevRel](https://changelog.com/posts/three-pillars-of-developer-relations)
...
### [Uma explicação profunda sobre Shell no Node.js](https://2ality.com/2022/07/nodejs-child-process.html)
