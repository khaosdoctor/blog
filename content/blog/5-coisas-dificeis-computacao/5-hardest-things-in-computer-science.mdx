...
Some months have 30 days, others have 31, and only one of them has 28 days, but it can have 29 every 4 years. The logic behind the count is solid and makes sense, but we could have been more efficient and split the months into 28 days each, adding an extra month.<Sidenote>[This has already been proposed and discussed](https://pt.wikipedia.org/wiki/Calend%C3%A1rio_Fixo_Internacional).</Sidenote>
