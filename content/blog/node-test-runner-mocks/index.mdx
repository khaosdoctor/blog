...
A grande vantagem (e o motivo pelo qual eu recomendo usar o contexto local **sempre**) é que, quando um teste acabar, ele vai automaticamente limpar e remover o mock, dessa forma um mock não vai interferir em outro mock.<MarginNote>**Fun Fact:** Tivemos esse problema durante uma das lives na nossa comunidade da [Formação TS](https://formacaots.com.br?utm_source=personal-blog&utm_medium=post&utm_campaign=ntr-mocks&utm_id=fixed). Quando estávamos fazendo o módulo de testes com o Node.js Test Runner, acidentalmente criamos um mock global que acabou interferindo em todos os testes do projeto.</MarginNote>
