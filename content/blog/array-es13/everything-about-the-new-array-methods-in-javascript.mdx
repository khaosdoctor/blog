...
-   The return is `0`, nothing changes

> You can find this documentation on [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort)
...
-   `...items` is an optional parameter that, if passed, sets the new value at position `start` after removing all the items from `deleteCount`
