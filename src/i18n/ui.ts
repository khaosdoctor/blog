...
const pt = {
  ...
  fontToggle: 'Alternar fonte de leitura',
  ...
  categoryDescription: 'Todos os artigos da categoria %s.',
  categories: 'Categorias',
  categoriesIntro: 'Todas as categorias do blog, com quantos artigos cada uma tem e quando saiu o último.',
  lastPost: 'último artigo em %s',
...
export const ui: Record<Locale, Record<UIKey, string>> = {
  ...
  en: {
    ...
    fontFamilySans: 'Sans',
    fontToggle: 'Toggle reading font',
    accentLabel: 'Accent',
    accentAuto: 'Auto',
    accentRed: 'Red',
    accentGreen: 'Green',
    ...
    accentPurple: 'Purple',
    accentWhite: 'White',
    backgroundLife: 'Game of life background',
    conwayKnobs: 'Game settings',
    ...
    categoryDescription: 'Every article in the %s category.',
    categories: 'Categories',
    categoriesIntro:
      'Every category on the blog, with how many articles each one holds and when the last one came out.',
    lastPost: 'latest article on %s',
