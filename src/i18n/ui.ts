...
const pt = {
  ...
  sections: 'Seções',
  sectionsIntro: 'Todas as seções do blog, com quantos artigos cada uma tem e quando saiu o último.',
...
export const ui: Record<Locale, Record<UIKey, string>> = {
  ...
  en: {
    ...
    sections: 'Sections',
    sectionsIntro: 'Every section of the blog, with how many articles each one holds and when the last one came out.',
