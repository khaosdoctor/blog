...
const AUTHOR_PROFILES = [
  AUTHOR_GITHUB,
  "https://x.com/_staticvoid",
  "https://www.linkedin.com/in/lsantosdev/",
];
...
export function sectionOgImage(lang: string, sectionUrl?: string): string {
  ...
  const section = sectionUrl
    ...
    .at(-1);
  const card =
    section && OG_SECTION_CARDS.includes(section) ? section : "default";
...
export function buildPrimaryJsonLd(
  type: PageType,
  input: JsonLdInput,
